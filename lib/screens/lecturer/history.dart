...
class _LecturerHistoryState extends State<LecturerHistory> {
  ...
  Future<void> getHistory() async {
    ...
    Uri uri = Uri.parse(
        '$url/api/lecturer_history?asset_name=$assetName&category=$_selectedCategory&borrow_status=$_selectedStatus&borrow_date=$borrowDateStr&return_date=$returnDateStr');
    try {
