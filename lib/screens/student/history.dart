...
class _StudentHistoryState extends State<StudentHistory> {
  ...
  Future<void> getHistory() async {
    ...
    Uri uri = Uri.parse(
        '$url/api/student_history?asset_name=$assetName&category=$_selectedCategory&borrow_status=$_selectedStatus&borrow_date=$borrowDateStr&return_date=$returnDateStr');
    try {
